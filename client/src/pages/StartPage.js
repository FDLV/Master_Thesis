  ...
  return (
    <div className="main">
      ...
      <div className="Content">
        <div className="Text">
          Мы рады, что вы проявляете интерес к нашей разработке. Мы в свою очередь делаем всё, чтобы
          вы были довольны и испытывали только положительные эмоции при использовании нашего
          портала!
        </div>
